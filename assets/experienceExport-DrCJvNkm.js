const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/experienceExportWord-v4mqPDA9.js","assets/index-Cqn09zkh.js","assets/ExperienceExportMenu-DHYoQeXD.js","assets/index-CBj0Y9rQ.js","assets/session-BE_DFqmd.js","assets/index-CNbQdLjI.css","assets/send-Cpe-UsXk.js","assets/planEntitlements-okUu8Y_U.js","assets/useMembershipCheckout-Bxlw5ziT.js","assets/membershipCatalog-D7H_hQQ5.js","assets/MembershipCheckoutDialog-DZ00VzLZ.js","assets/index-Dpj4193A.js","assets/headphones-BxpSafr1.js","assets/minus-DKSrgCgE.js","assets/chevron-right-B12gs-QI.js","assets/shield-check-_E0uI9I4.js","assets/MembershipCheckoutDialog-BLCFJ64y.css","assets/resumeFieldConstraints-DbxguhAK.js","assets/rotate-cw-Bh_ELZTF.js","assets/download-CUZOrOeu.js","assets/lock-B6eeyWpU.js","assets/ExperienceExportMenu-BnuhLJ6X.css","assets/exportDocumentTheme-C7TIl_-K.js","assets/html2canvasColors-CeWDj_2g.js"])))=>i.map(i=>d[i]);
import{c8 as R}from"./index-CBj0Y9rQ.js";import{e as O,o as U,q as X,s as Y,N as y,v as C,w as G,x as V,g as J,l as K}from"./ExperienceExportMenu-DHYoQeXD.js";import{b as n,a as T,e as Q}from"./exportDocumentTheme-C7TIl_-K.js";function Z(t){const o=[{label:"类型",value:O[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(e=>e.value&&e.value!==t.title.trim());return{title:t.title.trim(),metadata:o}}const z=18,tt=38,B={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function l(t){return t.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[o])}function L(t,o){const e=Array.from(t.trim());return e.length>o?`${e.slice(0,Math.max(1,o-1)).join("")}…`:e.join("")}function _(t,o,e){const r=Array.from(t.trim()),a=[];for(let s=0;s<r.length&&a.length<e;s+=o)a.push(r.slice(s,s+o).join(""));return r.length>o*e&&a.length>0&&(a[a.length-1]=L(a[a.length-1],o)),a.length>0?a:[""]}function j(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function et(t){const o=j(t.style?.width),e=j(t.style?.height);return`
    <g>
