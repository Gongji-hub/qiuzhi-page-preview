const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/experienceExportWord-BxasVrJm.js","assets/index-Cqn09zkh.js","assets/ExperienceExportMenu-Bq6r2rgG.js","assets/index-DQwWcL1M.js","assets/session-BE_DFqmd.js","assets/index-Br0C-hS3.css","assets/send-DeaSXFRX.js","assets/planEntitlements-okUu8Y_U.js","assets/useMembershipCheckout-lSQa_coW.js","assets/membershipCatalog-4bbVH6W-.js","assets/MembershipCheckoutDialog-BBNJI4lA.js","assets/index-Cs2tOG0S.js","assets/headphones-CVeMbUmE.js","assets/minus-BLgpbzj5.js","assets/chevron-right-BUaxhMH2.js","assets/shield-check-QAuyX9B6.js","assets/MembershipCheckoutDialog-BLCFJ64y.css","assets/resumeFieldConstraints-C75ri-NV.js","assets/share-2-Bh52U27L.js","assets/download-kaUxDwsO.js","assets/lock-ONQYRqpH.js","assets/ExperienceExportMenu-BnuhLJ6X.css","assets/exportDocumentTheme-B0k6QV6f.js","assets/html2canvasColors-CeWDj_2g.js"])))=>i.map(i=>d[i]);
import{c9 as R}from"./index-DQwWcL1M.js";import{e as O,q as U,s as X,v as Y,N as b,w as C,x as G,y as V,g as J,m as K,l as Q}from"./ExperienceExportMenu-Bq6r2rgG.js";import{b as i,a as T,e as Z}from"./exportDocumentTheme-B0k6QV6f.js";function tt(t){const o=[{label:"类型",value:O[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(e=>e.value&&e.value!==t.title.trim());return{title:t.title.trim(),metadata:o}}const z=18,et=38,B={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function l(t){return t.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[o])}function L(t,o){const e=Array.from(t.trim());return e.length>o?`${e.slice(0,Math.max(1,o-1)).join("")}…`:e.join("")}function _(t,o,e){const r=Array.from(t.trim()),s=[];for(let a=0;a<r.length&&s.length<e;a+=o)s.push(r.slice(a,a+o).join(""));return r.length>o*e&&s.length>0&&(s[s.length-1]=L(s[s.length-1],o)),s.length>0?s:[""]}function j(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function ot(t){const o=j(t.style?.width),e=j(t.style?.height);return`
    <g>
