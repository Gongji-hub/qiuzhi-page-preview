const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/experienceExportWord-CaVlijVF.js","assets/index-Cqn09zkh.js","assets/ExperienceExportMenu-DhxYWg7v.js","assets/index-CUbrCU2Z.js","assets/session-BE_DFqmd.js","assets/index-Br0C-hS3.css","assets/send-BopSEuFw.js","assets/planEntitlements-okUu8Y_U.js","assets/useMembershipCheckout-DBFwNFUZ.js","assets/membershipCatalog-tQm3n2il.js","assets/MembershipCheckoutDialog-DDiwqRyK.js","assets/index-OT1nd-u_.js","assets/headphones-DuBumU3S.js","assets/minus-DsnYrs3n.js","assets/chevron-right-DLdmCey7.js","assets/shield-check-BIlRslNh.js","assets/MembershipCheckoutDialog-BLCFJ64y.css","assets/resumeFieldConstraints-CDOH1p6j.js","assets/share-2-DZg38MHK.js","assets/download-n_EXeu6F.js","assets/lock-FB5dbZIp.js","assets/ExperienceExportMenu-BnuhLJ6X.css","assets/exportDocumentTheme-Sl_c9lXq.js","assets/html2canvasColors-CeWDj_2g.js"])))=>i.map(i=>d[i]);
import{c9 as R}from"./index-CUbrCU2Z.js";import{e as O,q as U,s as X,v as Y,N as b,w as C,x as G,y as V,g as J,m as K,l as Q}from"./ExperienceExportMenu-DhxYWg7v.js";import{b as i,a as T,e as Z}from"./exportDocumentTheme-Sl_c9lXq.js";function tt(t){const o=[{label:"类型",value:O[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(e=>e.value&&e.value!==t.title.trim());return{title:t.title.trim(),metadata:o}}const z=18,et=38,B={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function l(t){return t.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[o])}function L(t,o){const e=Array.from(t.trim());return e.length>o?`${e.slice(0,Math.max(1,o-1)).join("")}…`:e.join("")}function _(t,o,e){const r=Array.from(t.trim()),s=[];for(let a=0;a<r.length&&s.length<e;a+=o)s.push(r.slice(a,a+o).join(""));return r.length>o*e&&s.length>0&&(s[s.length-1]=L(s[s.length-1],o)),s.length>0?s:[""]}function j(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function ot(t){const o=j(t.style?.width),e=j(t.style?.height);return`
    <g>
