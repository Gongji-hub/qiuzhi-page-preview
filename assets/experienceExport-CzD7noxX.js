import{e as X,o as Y,q as O,C as L,s as _,v as S,N as j,w as J,x as K,y as Q,g as V,l as Z,k as tt}from"./ExperienceExportMenu-BgD-q1Pa.js";import{a as r,e as N}from"./exportDocumentTheme-Ddd9Ilk8.js";import{e as et}from"./exportElementPdf-Da8JW5mS.js";import"./index-EVwmqLrK.js";import"./session-B15EJOhV.js";import"./send-BQCph4U4.js";import"./planEntitlements-okUu8Y_U.js";import"./useMembershipCheckout-ORyLaUhW.js";import"./membershipCatalog-niuxERSX.js";import"./MembershipCheckoutDialog-CLCfKYhl.js";import"./index-lWT-oIdF.js";import"./headphones-BhvNBJgn.js";import"./minus-D7KSDBz-.js";import"./chevron-right-B8dR9-kT.js";import"./shield-check-C5sNNH60.js";import"./arrow-left-BdYkq_m4.js";import"./resumeFieldConstraints-Dw3fN2IV.js";import"./rotate-cw-B-i7GEwm.js";import"./download-B8Z1iJqN.js";import"./lock-f5p1rmty.js";import"./html2canvasColors-CeWDj_2g.js";function ot(t){const e=[{label:"类型",value:X[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(o=>o.value&&o.value!==t.title.trim());return{title:t.title.trim(),metadata:e}}const z=18,it=38,W={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function p(t){return t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[e])}function C(t,e){const o=Array.from(t.trim());return o.length>e?`${o.slice(0,Math.max(1,e-1)).join("")}…`:o.join("")}function T(t,e,o){const n=Array.from(t.trim()),a=[];for(let s=0;s<n.length&&a.length<o;s+=e)a.push(n.slice(s,s+e).join(""));return n.length>e*o&&a.length>0&&(a[a.length-1]=C(a[a.length-1],e)),a.length>0?a:[""]}function H(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function rt(t){const e=H(t.style?.width),o=H(t.style?.height);return`
    <g>
