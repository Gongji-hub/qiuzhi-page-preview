const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/experienceExportWord-CMfTNTqT.js","assets/index-Cqn09zkh.js","assets/ExperienceExportMenu-Cqn2SkzX.js","assets/index-CJy-Ftad.js","assets/session-BE_DFqmd.js","assets/index-D8mTHbIm.css","assets/send-cvvmlzec.js","assets/planEntitlements-okUu8Y_U.js","assets/useMembershipCheckout-D65CIYIJ.js","assets/membershipCatalog-BKSUUuyD.js","assets/MembershipCheckoutDialog-BERGiOBS.js","assets/index-Dydk52AM.js","assets/headphones-s2WfpYaL.js","assets/minus-CyQOeyFe.js","assets/chevron-right-B5z8fEhR.js","assets/shield-check-C2qQaIWe.js","assets/MembershipCheckoutDialog-BLCFJ64y.css","assets/resumeFieldConstraints-COsLEzQL.js","assets/rotate-cw-Dx3b23J5.js","assets/download-4E3KZ3T8.js","assets/lock-DI386KJH.js","assets/ExperienceExportMenu-BnuhLJ6X.css","assets/exportDocumentTheme-BOLuw2EM.js","assets/html2canvasColors-CeWDj_2g.js"])))=>i.map(i=>d[i]);
import{c8 as R}from"./index-CJy-Ftad.js";import{e as O,o as U,q as X,s as Y,N as y,v as C,w as G,x as V,g as J,l as K}from"./ExperienceExportMenu-Cqn2SkzX.js";import{b as n,a as T,e as Q}from"./exportDocumentTheme-BOLuw2EM.js";function Z(t){const o=[{label:"类型",value:O[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(e=>e.value&&e.value!==t.title.trim());return{title:t.title.trim(),metadata:o}}const z=18,tt=38,B={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function l(t){return t.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[o])}function L(t,o){const e=Array.from(t.trim());return e.length>o?`${e.slice(0,Math.max(1,o-1)).join("")}…`:e.join("")}function _(t,o,e){const r=Array.from(t.trim()),a=[];for(let s=0;s<r.length&&a.length<e;s+=o)a.push(r.slice(s,s+o).join(""));return r.length>o*e&&a.length>0&&(a[a.length-1]=L(a[a.length-1],o)),a.length>0?a:[""]}function j(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function et(t){const o=j(t.style?.width),e=j(t.style?.height);return`
    <g>
