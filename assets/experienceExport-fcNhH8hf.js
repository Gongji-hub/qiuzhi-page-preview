const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/experienceExportWord-DG7YK8kB.js","assets/index-Cqn09zkh.js","assets/ExperienceExportMenu-Bs76e3Uc.js","assets/index-Bz_H95ID.js","assets/session-BE_DFqmd.js","assets/index-Dn-U1UmS.css","assets/send-vO3bXuy8.js","assets/planEntitlements-okUu8Y_U.js","assets/useMembershipCheckout-D8Jp2v3t.js","assets/membershipCatalog-DL35S2T8.js","assets/MembershipCheckoutDialog-BzFA9O2o.js","assets/index-B6c2uI0L.js","assets/headphones-CIYwKtMn.js","assets/minus-DIqKVMnQ.js","assets/chevron-right-C3prc7aK.js","assets/shield-check-D3XWuaZ4.js","assets/MembershipCheckoutDialog-BLCFJ64y.css","assets/resumeFieldConstraints-Ckf5HAP6.js","assets/rotate-cw-DLtNh08V.js","assets/download-ChK-n6G3.js","assets/lock-Chy0ORmx.js","assets/ExperienceExportMenu-BnuhLJ6X.css","assets/exportDocumentTheme-nAT504HC.js","assets/html2canvasColors-CeWDj_2g.js"])))=>i.map(i=>d[i]);
import{c8 as R}from"./index-Bz_H95ID.js";import{e as O,q as U,s as X,v as Y,N as b,w as C,x as G,y as V,g as J,m as K,l as Q}from"./ExperienceExportMenu-Bs76e3Uc.js";import{b as i,a as T,e as Z}from"./exportDocumentTheme-nAT504HC.js";function tt(t){const o=[{label:"类型",value:O[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(e=>e.value&&e.value!==t.title.trim());return{title:t.title.trim(),metadata:o}}const z=18,et=38,B={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function l(t){return t.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[o])}function L(t,o){const e=Array.from(t.trim());return e.length>o?`${e.slice(0,Math.max(1,o-1)).join("")}…`:e.join("")}function _(t,o,e){const r=Array.from(t.trim()),s=[];for(let a=0;a<r.length&&s.length<e;a+=o)s.push(r.slice(a,a+o).join(""));return r.length>o*e&&s.length>0&&(s[s.length-1]=L(s[s.length-1],o)),s.length>0?s:[""]}function j(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function ot(t){const o=j(t.style?.width),e=j(t.style?.height);return`
    <g>
