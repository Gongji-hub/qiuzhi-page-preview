const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/experienceExportWord-Df3CsJnA.js","assets/index-SOkX4K_1.js","assets/ExperienceExportMenu-Carig4ba.js","assets/index-B08cw_hA.js","assets/session-BE_DFqmd.js","assets/index-DVTEuxCK.css","assets/send-FyhWE6-O.js","assets/planEntitlements-okUu8Y_U.js","assets/useMembershipCheckout-18AeVucN.js","assets/membershipCatalog-D-kBrm0Y.js","assets/MembershipCheckoutDialog-CgZQxiof.js","assets/index-84BbihQY.js","assets/headphones-DQgbtXvA.js","assets/minus-DCtBzO80.js","assets/chevron-right-Drmcq0_7.js","assets/shield-check-S_iVLjey.js","assets/MembershipCheckoutDialog-BLCFJ64y.css","assets/resumeFieldConstraints-CNOpxCR2.js","assets/rotate-cw-K0MI9QUl.js","assets/download-DhF1DjnQ.js","assets/lock-DPhKpH6O.js","assets/ExperienceExportMenu-BnuhLJ6X.css","assets/exportDocumentTheme-CCt47JZF.js","assets/html2canvasColors-CeWDj_2g.js"])))=>i.map(i=>d[i]);
import{cl as R}from"./index-B08cw_hA.js";import{e as O,o as U,q as X,s as Y,N as y,v as C,w as G,x as V,g as J,l as K}from"./ExperienceExportMenu-Carig4ba.js";import{b as n,a as T,e as Q}from"./exportDocumentTheme-CCt47JZF.js";function Z(t){const o=[{label:"类型",value:O[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(e=>e.value&&e.value!==t.title.trim());return{title:t.title.trim(),metadata:o}}const z=18,tt=38,B={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function l(t){return t.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[o])}function L(t,o){const e=Array.from(t.trim());return e.length>o?`${e.slice(0,Math.max(1,o-1)).join("")}…`:e.join("")}function _(t,o,e){const r=Array.from(t.trim()),a=[];for(let s=0;s<r.length&&a.length<e;s+=o)a.push(r.slice(s,s+o).join(""));return r.length>o*e&&a.length>0&&(a[a.length-1]=L(a[a.length-1],o)),a.length>0?a:[""]}function j(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function et(t){const o=j(t.style?.width),e=j(t.style?.height);return`
    <g>
