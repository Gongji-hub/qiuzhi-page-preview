import{e as X,o as Y,q as O,C as L,s as _,v as S,N as j,w as J,x as K,y as Q,g as V,l as Z,k as tt}from"./ExperienceExportMenu-DjXQ9mue.js";import{a as r,e as N}from"./exportDocumentTheme-Ddd9Ilk8.js";import{e as et}from"./exportElementPdf-VXHn5ZVG.js";import"./index-Cm9qkEA2.js";import"./session-B15EJOhV.js";import"./send-CY64amFw.js";import"./planEntitlements-okUu8Y_U.js";import"./useMembershipCheckout-Rqiuiuxs.js";import"./membershipCatalog-dUtdRKtd.js";import"./MembershipCheckoutDialog-BOl0c8kG.js";import"./index-C1fBUn72.js";import"./headphones-B-cPwZj5.js";import"./minus-BxVQn44N.js";import"./chevron-right-CFWb8Qot.js";import"./shield-check-SfnSafnT.js";import"./arrow-left-DYNHaLCz.js";import"./resumeFieldConstraints-BBagUslk.js";import"./rotate-cw-BcKRD4vN.js";import"./download-DF6_O2eG.js";import"./lock-D4PBmcYM.js";import"./html2canvasColors-CeWDj_2g.js";function ot(t){const e=[{label:"类型",value:X[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(o=>o.value&&o.value!==t.title.trim());return{title:t.title.trim(),metadata:e}}const z=18,it=38,W={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function p(t){return t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[e])}function C(t,e){const o=Array.from(t.trim());return o.length>e?`${o.slice(0,Math.max(1,e-1)).join("")}…`:o.join("")}function T(t,e,o){const n=Array.from(t.trim()),a=[];for(let s=0;s<n.length&&a.length<o;s+=e)a.push(n.slice(s,s+e).join(""));return n.length>e*o&&a.length>0&&(a[a.length-1]=C(a[a.length-1],e)),a.length>0?a:[""]}function H(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function rt(t){const e=H(t.style?.width),o=H(t.style?.height);return`
    <g>
