const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/experienceExportWord-CoKlpaVA.js","assets/index-Cqn09zkh.js","assets/ExperienceExportMenu-e1OPXn92.js","assets/index-B-u8NyXk.js","assets/session-BE_DFqmd.js","assets/index-DVTEuxCK.css","assets/send-BP5f96-N.js","assets/planEntitlements-okUu8Y_U.js","assets/useMembershipCheckout-D4fvR4Lr.js","assets/membershipCatalog-BWpZbgFK.js","assets/MembershipCheckoutDialog-DbdRdsuX.js","assets/index-0x_K4nXE.js","assets/headphones-Ncno4nMw.js","assets/minus-BmV_VfQg.js","assets/chevron-right-FfOj0KTE.js","assets/shield-check-BzclwljC.js","assets/MembershipCheckoutDialog-BLCFJ64y.css","assets/resumeFieldConstraints-Cw9_AJZl.js","assets/rotate-cw-VuzMcPs7.js","assets/download-CQrC9M_X.js","assets/lock-BZTtslUl.js","assets/ExperienceExportMenu-BnuhLJ6X.css","assets/exportDocumentTheme-CAlGykm5.js","assets/html2canvasColors-CeWDj_2g.js"])))=>i.map(i=>d[i]);
import{c8 as R}from"./index-B-u8NyXk.js";import{e as O,o as U,q as X,s as Y,N as y,v as C,w as G,x as V,g as J,l as K}from"./ExperienceExportMenu-e1OPXn92.js";import{b as n,a as T,e as Q}from"./exportDocumentTheme-CAlGykm5.js";function Z(t){const o=[{label:"类型",value:O[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(e=>e.value&&e.value!==t.title.trim());return{title:t.title.trim(),metadata:o}}const z=18,tt=38,B={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function l(t){return t.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[o])}function L(t,o){const e=Array.from(t.trim());return e.length>o?`${e.slice(0,Math.max(1,o-1)).join("")}…`:e.join("")}function _(t,o,e){const r=Array.from(t.trim()),a=[];for(let s=0;s<r.length&&a.length<e;s+=o)a.push(r.slice(s,s+o).join(""));return r.length>o*e&&a.length>0&&(a[a.length-1]=L(a[a.length-1],o)),a.length>0?a:[""]}function j(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function et(t){const o=j(t.style?.width),e=j(t.style?.height);return`
    <g>
