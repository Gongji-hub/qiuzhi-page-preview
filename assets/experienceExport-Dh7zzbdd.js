import{e as X,q as Y,s as O,C as L,v as _,w as S,N as j,x as J,y as K,z as Q,g as V,m as Z,l as tt}from"./ExperienceExportMenu-S9tWMyjA.js";import{a as r,e as N}from"./exportDocumentTheme-Ddd9Ilk8.js";import{e as et}from"./exportElementPdf-Bew4zN7H.js";import"./index-nx114l-G.js";import"./session-B15EJOhV.js";import"./send-jvTesK2U.js";import"./planEntitlements-okUu8Y_U.js";import"./useMembershipCheckout-CULrfxUq.js";import"./membershipCatalog-Cg_q0MyH.js";import"./MembershipCheckoutDialog-CtiOL19c.js";import"./index-KM3mTO5f.js";import"./headphones-CfVxSHqn.js";import"./minus-DWj7JD5Y.js";import"./chevron-right-BSFqgFTE.js";import"./shield-check-C7-Hg54p.js";import"./arrow-left-DxCp4q2g.js";import"./resumeFieldConstraints-B96ra8kC.js";import"./rotate-cw-s3l4-t6L.js";import"./download-DB_a2ox6.js";import"./lock-BIvPI5bS.js";import"./html2canvasColors-CeWDj_2g.js";function ot(t){const e=[{label:"类型",value:X[t.type]},{label:"组织",value:t.organization.trim()},{label:"角色",value:t.role?.trim()||""},{label:"时间",value:t.period.trim()}].filter(o=>o.value&&o.value!==t.title.trim());return{title:t.title.trim(),metadata:e}}const z=18,it=38,W={fact:"#238653",inferred:"#b7791f",unverified:"#c54f4b",missing:"#8994a0"};function p(t){return t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&apos;"})[e])}function C(t,e){const o=Array.from(t.trim());return o.length>e?`${o.slice(0,Math.max(1,e-1)).join("")}…`:o.join("")}function T(t,e,o){const n=Array.from(t.trim()),a=[];for(let s=0;s<n.length&&a.length<o;s+=e)a.push(n.slice(s,s+e).join(""));return n.length>e*o&&a.length>0&&(a[a.length-1]=C(a[a.length-1],e)),a.length>0?a:[""]}function H(t){return typeof t=="number"?t:Number.parseFloat(t??"0")||0}function rt(t){const e=H(t.style?.width),o=H(t.style?.height);return`
    <g>
